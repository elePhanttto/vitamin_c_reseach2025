...
from vitamin_c.models.neural_networks import vae_utils
...
class VariationalAutoencoder(object):
    ...
    def __init__(self, name, wrap_mask, nowrap_mask, m1_mask, m2_mask, sky_mask, n_input1=4, n_input2=256, n_output=3, n_channels=3, n_weights=2048, drate=0.2, n_filters=8, filter_size=8, maxpool=4):
        ...
        self.nonlinear_scale_nowrap = tf.nn.softplus   # activation for non-wrapped scale params
        self.nonlinear_scale_wrap = tf.nn.softplus      # activation for wrapped scale params #ここをsoft...に変えるのだ
        self.nonlinear_scale_m1 = tf.nn.softplus      # activation for mass params
        self.nonlinear_scale_m2 = tf.nn.softplus        # activation for mass params  
        self.nonlinear_scale_sky = tf.nn.softplus       # activation for sky params
