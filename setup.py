...
setup(
    ...
    url='https://github.com/hagabbar/vitamin_c',
    ...
    packages=['vitamin_c','vitamin_c.models','vitamin_c.models.neural_networks',
              'vitamin_c.params_files','vitamin_c.data'],
    package_dir={'vitamin_c': 'vitamin_c'},
    package_data={'vitamin_c': ['params_files/*.json'],
                  'vitamin_c': [version_file]},
